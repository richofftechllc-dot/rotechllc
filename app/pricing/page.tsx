      ...
      <div className="border-2 border-orange-500/30 rounded-2xl p-8 md:p-12 relative">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-zinc-900 border border-white/10 rounded-xl p-8 text-center">
            ...
            <a href="https://square.link/u/gGNBn35n" target="_blank" rel="noopener" className="block w-full py-4 bg-gradient-to-r from-orange-500 to-red-500 font-bold rounded-lg">Lock In Founding</a>
            <div className="text-green-500 text-sm mt-4">● 62 / 100 spots claimed</div>
