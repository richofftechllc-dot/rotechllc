...
export default function About() {
  return (
    <>
      ...
      <section id="about" className="bg-rot-sunken py-24 border-b border-rot-line scroll-mt-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-rot-accent font-bold tracking-widest text-sm mb-4">ABOUT · RICH OFF TECH LLC · EST. JANUARY 2025</div>
          <h1 className="text-5xl md:text-6xl font-black mb-12">Guided by Experience.<br />Powered by Purpose.</h1>
          <p className="text-rot-muted text-lg max-w-3xl mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16 items-start">
            <div className="grid grid-cols-2 gap-3">
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-rot-line">
              ...
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-rot-line mt-8">
            ...
            <div className="space-y-6">
              <div>
                <div className="text-rot-accent font-bold tracking-widest text-xs mb-3">THE MISSION</div>
                <p className="text-rot-muted text-base md:text-lg leading-relaxed mb-4">
                ...
                <p className="text-rot-muted text-base md:text-lg leading-relaxed mb-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-2 max-w-sm sm:max-w-none mx-auto sm:mx-0">
                  {["q7d0YmDx328", "SgsQpw0cbEM", "GcXTN3uVxOc"].map((id) => (
                    <div key={id} className="aspect-[9/16] rounded-lg overflow-hidden border border-rot-line bg-rot-bg">
                      <iframe
              ...
              <div>
                <div className="text-rot-accent font-bold tracking-widest text-xs mb-3">WHAT ROT IS</div>
                <p className="text-rot-muted text-base md:text-lg leading-relaxed mb-4">
                  Udemy, LinkedIn, and ClearanceJobs in one place. Quiz-driven cert tracks. A public roster recruiters scan. An AI agent — <b className="text-rot-accent">Bo Tech</b> — that lives in our Discord and acts as your live AI instructor during self-guided sessions: walks you through every lesson, drafts your resume in ATS-safe format, and answers questions at 3 AM. He moves with you: instructor during quizzes, tutor during lessons, on call in DM.
                </p>
                <p className="text-rot-muted text-base md:text-lg leading-relaxed mb-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-rot-surface border border-rot-line rounded-xl p-6"><div className="text-4xl font-black text-emerald-600">4+</div><div className="text-rot-muted text-sm mt-2">Years in IT &amp; Federal Tech</div></div>
            <div className="bg-rot-surface border border-rot-line rounded-xl p-6"><div className="text-4xl font-black text-emerald-600">TS/SCI</div><div className="text-rot-muted text-sm mt-2">Active Full Scope Poly</div></div>
            <div className="bg-rot-surface border border-rot-line rounded-xl p-6"><div className="text-4xl font-black text-emerald-600">4</div><div className="text-rot-muted text-sm mt-2">Consulting Services Offered</div></div>
            <div className="bg-rot-surface border border-rot-line rounded-xl p-6"><div className="text-4xl font-black text-emerald-600">100%</div><div className="text-rot-muted text-sm mt-2">Virtual &amp; Flexible Sessions</div></div>
          </div>
          <AboutMontage />
        </div>
      </section>
      ...
      <section className="bg-rot-sunken py-24 border-t border-rot-line">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-emerald-600 font-bold tracking-widest text-sm mb-4">WHAT CLIENTS SAY</div>
          ...
          <div className="bg-rot-surface border border-emerald-600/25 rounded-2xl p-6 mb-8">
            <div className="text-emerald-600 font-bold tracking-widest text-xs mb-2">FEATURED · D. KNIGHT&apos;S JOURNEY</div>
            <div className="font-bold text-xl mb-1">Just listen to the journey.</div>
            <div className="text-rot-faint text-sm mb-4">From the ground up — how D. Knight broke into cleared tech and crossed $200K/yr.</div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-rot-surface border border-rot-line rounded-2xl p-6">
              ...
              <div className="text-rot-faint text-sm mb-4">200k+ a year — ROTech alum</div>
            ...
            <div className="bg-rot-surface border border-rot-line rounded-2xl p-6">
              ...
              <div className="text-rot-faint text-sm mb-4">Former Military — ISSO</div>
              <div className="aspect-video rounded-lg overflow-hidden">
